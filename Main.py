...
from AccuracyPrediction import *

#Using the model_accuracy definition in AccuracyPrediction to get accuracy rate
from sklearn.naive_bayes import MultinomialNB
multinomialModel = MultinomialNB()
multinomialAccuracy = AccuracyPrediction.model_fit_and_predict(multinomialModel, training_data, training_markups, test_data, test_markups)

from sklearn.ensemble import AdaBoostClassifier
adaBoostModel = AdaBoostClassifier()
adaBoostAccuracy = AccuracyPrediction.model_fit_and_predict(adaBoostModel, training_data, training_markups, test_data, test_markups)
...
test = AccuracyPrediction.model_predict(winner, validation_data, validation_markups)
